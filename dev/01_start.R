...
golem::fill_desc(
  pkg_name = "NullarborReader", # The Name of the package containing the App 
  pkg_title = "Nullarbor reader", # The Title of the package containing the App 
  pkg_description = "Nullarbor reader using gollem", # The Description of the package containing the App 
  author_first_name = "Pierre-Yves", # Your First Name
  author_last_name = "Dupont",  # Your Last Name
  author_email = "pierre.dupont@esr.cri.nz",      # Your Email
